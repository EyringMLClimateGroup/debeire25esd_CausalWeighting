...
model_name = sorted([
    os.path.basename(file_path) for file_path in glob.glob(
        '/work/bd1083/b309165/CMIP6_CME/output_pca/CMIP6_era5_1979-2014_weights_timebin1/*.bin')
])
model_path = "/work/bd1083/b309165/CMIP6_CME/output_pca/CMIP6_era5_1979-2014_weights_timebin1/"
...
print(len(model_name[first_model_idx:last_model_idx]))
for model in model_name[first_model_idx:last_model_idx]:
    for method_arg in ['pcmci']:
        ...
        file_name = '/work/bd1083/b309165/CMIP6_CME/output_pcmci/CMIP6_era5_1979-2014_weights_timebin1x2_selectedcomps/results_%s_%d-VAR_%d-LAG_%s.bin' % (
