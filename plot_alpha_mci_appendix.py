...
if use_CMIP6_data:
    ...
    pcmci_res_path="/work/bd1083/b309165/CMIP6_CME/output_pcmci/CMIP6_ncar_1979-2014_weights_timebin1x2_60selectedcomps_taumax20/"
    #pr paths
    ...
    global_res_path = "/work/bd1083/b309165/CMIP6_CME/results/results_CMIP6/global_link_and_parents_1979-2014_weights_psl_timebin1x2_60selectedcomps_taumax20.bin"
...
ranks_df_ref = df_plot_perf.rank(axis=0, ascending=False, method='min')
ranks_df_ref.rename(columns = {'F1-score':'Rank'}, inplace = True)
ranks_df_ref.to_csv("performance_60comps_ranks.csv",index=False)
################END REFERENCE###################################################################################
####This cell creates df_f1score pandasframe which stores WDM for all season,model,ensemble triplets
alpha = 0.0001
ref_ds="ncar"
...
barplot(xr_plot_perf , ranks_df, "performance_60comps_alpha0_0001.pdf",r' (60 components, $\alpha_{MCI}=10^{-4}$)',ranks_df_ref)
...
ranks_df = df_plot_perf.rank(axis=0, ascending=False, method='min')
ranks_df.rename(columns = {'F1-score':'Rank'}, inplace = True)
barplot(xr_plot_perf , ranks_df, "performance_60comps_alpha0_001.pdf",r' (60 components, $\alpha_{MCI}=10^{-3}$)',ranks_df_ref)
# pdfjam performance_60comps_alpha0_0001.pdf performance_60comps_alpha0_001.pdf --nup 2x1 --outfile performance_60comps_combined.pdf --papersize '{20cm,7cm}' --scale 1.0 --noautoscale false
